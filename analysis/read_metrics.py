...
read_stats("logdir/crafter_reward-dreamerv2", "scores", "crafter_reward", "dreamerv2")

read_stats("logdir/crafter_reward-ppo", "scores", "crafter_reward", "ppo")

read_stats("logdir/crafter_reward-rainbow", "scores", "crafter_reward", "rainbow")
...
read_stats(
    "logdir/crafter_noreward-unsup_rnd", "scores", "crafter_noreward", "unsup_rnd"
)

read_stats("logdir/crafter_noreward-random", "scores", "crafter_noreward", "random")

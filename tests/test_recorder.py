...
class TestRecorder(unittest.TestCase):
    ...
    def test_recorder_backward_compat_reset(self):
        ...
        env = crafter.Env()
        with tempfile.TemporaryDirectory() as tmpdir:
            env = crafter.Recorder(env, tmpdir, save_stats=False, save_video=False, save_episode=False)
            result = env.reset()
    ...
    def test_stats_recorder_saves_stats(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            env = crafter.Recorder(env, tmpdir, save_stats=True, save_video=False, save_episode=False)
            env.reset()
